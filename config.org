...
[[./yukari.png]]
* Introduction
This is a very simple and basic configuration file for Emacs. From here you can edit, remove, or add many aspects of Emacs you want. I encourage you to do so, because Emacs works best when it's customized to your own liking!
* Quick install
#+BEGIN_SRC 
...
#+BEGIN_SRC emacs-lisp
  (use-package dashboard
    ...
    (setq dashboard-banner-logo-title "P H A N T A S M - Emacs")
